...
public class admin_scroll_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_scroll);
    ...
    private void uploadFirebase1(Uri uri) {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                uploadTask.getResult().getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        firebaseFirestore.collection("scroll_items")
                                .add(urimodel)
                                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                    @Override
                                    public void onComplete(@NonNull Task<DocumentReference> task) {
                                        if(task.isComplete()){
                                            Toast.makeText(admin_scroll_activity.this, "uploaded succesfully", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(admin_scroll_activity.this, "uploading failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
