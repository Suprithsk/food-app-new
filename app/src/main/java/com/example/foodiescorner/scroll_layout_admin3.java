...
public class scroll_layout_admin3 extends AppCompatActivity {
    ...
    private void uploadFirebase1(Uri uri) {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                uploadTask.getResult().getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        firebaseFirestore.collection("scroll_items3")
                                .add(urimodel)
                                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                    @Override
                                    public void onComplete(@NonNull Task<DocumentReference> task) {
                                        if(task.isComplete()){
                                            Toast.makeText(scroll_layout_admin3.this, "uploaded succesfully", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(scroll_layout_admin3.this, "uploading failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
