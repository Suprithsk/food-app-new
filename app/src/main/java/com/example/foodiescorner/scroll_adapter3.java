...
public class scroll_adapter3 extends RecyclerView.Adapter<scroll_adapter3.ViewHolder> {

    ArrayList<scroll_model3> modelArrayList3;

    public scroll_adapter3(ArrayList<scroll_model3> modelArrayList3) {
        this.modelArrayList3 = modelArrayList3;
    }

    @NonNull
    @Override
    public scroll_adapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontal_scroll_item2,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull scroll_adapter3.ViewHolder holder, int position) {
        String resource=modelArrayList3.get(position).getProductImage();
        String rupees=modelArrayList3.get(position).getProductMoney();
        String product_title=modelArrayList3.get(position).getProductTitle();
